...
<!-- Header Bootstrap -->
<header class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top shadow-sm" style="backdrop-filter: blur(10px); background-color: rgba(15, 23, 42, 0.9) !important;">
