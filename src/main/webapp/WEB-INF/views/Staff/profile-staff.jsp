        ...
        <div class="wrap">
            <div class="container-centered">
                <div class="card">
                    ...
                    <!-- Profile Form -->
                    <form id="profileForm" class="body" action="${pageContext.request.contextPath}/staff/profile"
                    ...
                    <div class="card shadow-sm mt-3 hidden" id="passwordCard">
                        <div class="body">
                            ...
                            <form method="post" id="passwordForm" action="${pageContext.request.contextPath}/staff/profile" novalidate>
