...
/**
 * Get customer's current address (latest address)
 * This is used to compare with order address to show if customer has changed address
 */
...
/**
 * Get order address snapshot from OrderAddress table
 * This contains the delivery information captured at order placement time
 */
...
/**
 * Save order address snapshot when creating order
 * This should be called during order creation to preserve delivery information
 */
